...
internal constructor(
     ...
     */
    public suspend fun get(key: String): Any? = mutex.withLock {
        properties[key]
    }
     ...
     */
    public suspend fun remove(key: String): Any? = mutex.withLock {
     ...
     */
    public suspend fun toMap(): Map<String, Any> = mutex.withLock {
        properties.toMap()
    }
     ...
     */
    public suspend fun containsKey(key: String): Boolean = mutex.withLock {
